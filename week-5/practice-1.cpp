...
int main() {
	...
	*p = 30; 			// *p points to 30 so numberrs[2] = 30
	p = numbers + 3; 	// Address of numbers + 3 which is numbers[3] was assigned to p
	*p = 40; 			// *p points to 40 so numbers[3] = 40
	p = numbers; 		// Address of numbers which is numbers[0] as assigned to p
